...
public class ExcludeDemo {
    ...
    @BeforeMethod(alwaysRun = true)  // ✅ Changed from @BeforeSuite
    public void setup(){
    ...
    @AfterMethod(alwaysRun = true)  // ✅ Changed from @AfterSuite
    ...
    @Ignore
    @Test(groups = {"regression"},priority = 3,dependsOnMethods = "verifyDashboard")
    ...
    @Test(groups = {"smoke"},priority = 2, invocationCount =3)
